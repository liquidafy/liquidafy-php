...
/**
 * Verifies Webhook::constructEvent mirrors the backend signing scheme
...
final class WebhookTest extends TestCase
{
    ...
    /** Builds the exact wire header the backend dispatcher emits. */
    ...
    {
        // Backend: fail only when diff < -tol || diff > tol — ±300 passes.
